...
function WeaponNoBuild()
{
    // End:0xFC
    if(bPlasmaBuild == false)
    {
        theGameCore().ItemBalance_Normal[13].iTime = -1;
        theGameCore().ItemBalance_Normal[14].iTime = -1;
        theGameCore().ItemBalance_Normal[15].iTime = -1;
        theGameCore().ItemBalance_Normal[17].iTime = -1;
    }
    //return;    
}

function WeaponAdjustments()
{
    //return;    
}

function ArmorAdjustments()
{
    //return;    
}